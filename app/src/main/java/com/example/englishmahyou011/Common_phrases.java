...
public class Common_phrases extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ph1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent ph1Intent = new Intent(Common_phrases.this, Phrases1Activity.class);
        ...
        ph2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Create a new intent to open the {@link AlphabetActivity}
                Intent ph2Intent = new Intent(Common_phrases.this, Phrases2Activity.class);
        ...
        ph3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Create a new intent to open the {@link AlphabetActivity}
                Intent ph3Intent = new Intent(Common_phrases.this, Phrases3Activity.class);
        ...
        ph4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Create a new intent to open the {@link AlphabetActivity}
                Intent ph4Intent = new Intent(Common_phrases.this, Phrases4Activity.class);
